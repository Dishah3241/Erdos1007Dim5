...
private def auditedRoot : Name := `Erdos1007Dim5
...
private def generalRoots : Array Name := #[
  `Erdos1007Dim5.Algebra,
  `Erdos1007Dim5.Analysis,
  `Erdos1007Dim5.Combinatorics,
  `Erdos1007Dim5.Data,
  `Erdos1007Dim5.FieldTheory,
  `Erdos1007Dim5.LinearAlgebra,
  `Erdos1007Dim5.NumberTheory,
  `Erdos1007Dim5.Order,
  `Erdos1007Dim5.RingTheory,
  `Erdos1007Dim5.SetTheory,
  `Erdos1007Dim5.Topology,
]
...
private def leafRoots : Array Name := #[
  `Erdos1007Dim5.Examples,
  `Erdos1007Dim5.Standalone,
]
