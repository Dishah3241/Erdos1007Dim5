...
Reader-facing modules in `Erdos1007Dim5.Standalone.Mathlib` state results so that a reader can
...
private def standaloneMathlibDir : System.FilePath := "Erdos1007Dim5" / "Standalone" / "Mathlib"
...
private def forbiddenRoots : Array Name := #[`Erdos1007Dim5, `scripts]
